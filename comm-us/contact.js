...
const COPY = {
  en: {
    title: "Contact OPS",
    description: "Signal the engagement type and we will align the right cyber-resilient squad.",
    submit: "Log Request",
    close: "Close",
    success: "Saved locally — copy the payload below for your secure channel.",
  ...
  es: {
    title: "Contacta OPS",
    description: "Indica el tipo de engagement y alinearemos el escuadrón ciber-resiliente.",
    submit: "Registrar Solicitud",
    close: "Cerrar",
    success: "Guardado localmente — copia el payload para tu canal seguro.",
